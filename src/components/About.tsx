      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="text-center mb-16 space-y-3">
          ...
          <h2 className="font-display text-3xl md:text-4xl font-bold text-primary tracking-tight">
            Craving for Confectionery Perfection
          </h2>
          <p className="font-sans text-sm text-on-surface-variant max-w-lg mx-auto">
            At The Sweet Spot, we elevate premium baking into a fine art form, blending pure organic Jersey dairy cream, authentic Belgian chocolates, and a sprinkle of magic.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 text-left">
            <h3 className="font-display text-xl sm:text-2xl font-bold text-primary leading-snug">
              Choosy Baking, Small Batch Delicacies & Genuine Care 🌸
            </h3>
            <p className="font-sans text-sm text-on-surface-variant leading-relaxed">
              Founded under the simple tenet that cake should never taste ordinary or artificial, <strong className="text-primary font-bold">The Sweet Spot</strong> operates as a localized boutique micro-bakery. Every recipe sponge is individually whipped from scratch—there are zero premixes, zero high-fructose corn syrups, and strictly no artificial stabilizers inside our pantry.
            </p>
            <p className="font-sans text-sm text-on-surface-variant leading-relaxed">
              We sourcing fresh seasonal sweet strawberries, organic eggs, natural Madagascar vanilla pods, and genuine imported cocoa powders. This uncompromising devotion to raw ingredients translates directly into dense, velvety moist finishes that melt on your tongue.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <span className="font-display font-bold text-xs text-primary block">FSSAI Certified</span>
                  <span className="text-[10px] text-on-surface-variant font-normal">Strict sanitary food workspace checks</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <span className="font-display font-bold text-xs text-secondary block">100% Homemade</span>
                  <span className="text-[10px] text-on-surface-variant font-normal">Real cow ghee and rich dairy butter</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <span className="font-display font-bold text-xs text-amber-800 block">Artisan Crafting</span>
                  <span className="text-[10px] text-on-surface-variant font-normal">Tailored ribbons & handwritten letters</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <span className="font-display font-bold text-xs text-rose-800 block">Baked to Hour</span>
                  <span className="text-[10px] text-on-surface-variant font-normal">Dispatched warm within 3 hrs of setup</span>
                </div>
              </div>
            </div>
